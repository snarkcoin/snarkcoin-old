...
bech32_templates = [
  ...
  ('snark',   0, 20, (False, 'main',    None, True), p2wpkh_prefix),
  ('snark',   0, 32, (False, 'main',    None, True), p2wsh_prefix),
  ('snark',   1,  2, (False, 'main',    None, True), (OP_1, 2)),
  ('tsnark',  0, 20, (False, 'test',    None, True), p2wpkh_prefix),
  ('tsnark',  0, 32, (False, 'test',    None, True), p2wsh_prefix),
  ('tsnark',  2, 16, (False, 'test',    None, True), (OP_2, 16)),
  ('rsnark',  0, 20, (False, 'regtest', None, True), p2wpkh_prefix),
  ('rsnark',  0, 32, (False, 'regtest', None, True), p2wsh_prefix),
  ('rsnark', 16, 40, (False, 'regtest', None, True), (OP_16, 40))
]
# templates for invalid bech32 sequences
bech32_ng_templates = [
  # hrp, version, witprog_size, invalid_bech32, invalid_checksum, invalid_char
  ('tc',    0, 20, False, False, False),
  ('tsnark',  17, 32, False, False, False),
  ('rsnark',  3,  1, False, False, False),
  ('snark',   15, 41, False, False, False),
  ('tsnark',  0, 16, False, False, False),
  ('rsnark',  0, 32, True,  False, False),
  ('snark',   0, 16, True,  False, False),
  ('tsnark',  0, 32, False, True,  False),
  ('rsnark',  0, 20, False, False, True)
]
...
def is_valid_bech32(v):
    ...
    for hrp in ['snark', 'tsnark', 'rsnark']:
