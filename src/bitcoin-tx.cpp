...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " snarkcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  snarkcoin-tx [options] <hex-tx> [commands]  Update hex-encoded snarkcoin transaction\n" +
            "or:     snarkcoin-tx [options] -create [commands]   Create hex-encoded snarkcoin transaction\n" +
            "\n";
