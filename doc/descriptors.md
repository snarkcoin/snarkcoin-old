# Support for Output Descriptors in Snarkcoin Core

Since Snarkcoin Core v0.17, there is support for Output Descriptors. This is a
...
- Segwit addresses (bech32, of the form `snark1...` for mainnet or `tsnark1...` for testnet, defined in [BIP 173](https://github.com/bitcoin/bips/blob/master/bip-0173.mediawiki)).
...
on Snarkcoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Snarkcoin Core wallets, a convenience function `combo` is
