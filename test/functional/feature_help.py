...
"""Verify that starting snarkcoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start snarkcoin with -h for help text")
        ...
        self.log.info("Start snarkcoin with -version for version information")
        ...
        self.log.info("Start snarkcoind with -fakearg to make sure it does not start")
